...
Your Linux needs to have at least **Python 3.10** installed (3.11 works as well), and let's say your Python can be called with command **python3** with your venv system working, you can:
